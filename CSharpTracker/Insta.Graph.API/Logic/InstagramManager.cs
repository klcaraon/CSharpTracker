...
namespace Insta.Graph.API.Logic
{
    public class InstagramManager
    {
        ...
        private string baseUrl = "https://graph.facebook.com/v8.0/17841403335681902?fields=";
        ...
        {
            string impressionsUrl = "https://graph.facebook.com/v8.0/" + mediaData.id + "/insights/?metric=impressions&access_token=" + _token;
